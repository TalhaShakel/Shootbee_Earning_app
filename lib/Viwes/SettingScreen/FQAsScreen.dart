...
class FAQScreen extends StatelessWidget {
  ...
  final List<FAQTextModel> FAQlList = [
    FAQTextModel(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            MyText(
                              text: ' ${index + 1}. ${fAQText.title}',
                              fontsize: 20,
                              fontweight: FontWeight.bold,
                            ),
                            Utils.verticalSpacer(24),
                            MyText(
                              text: fAQText.description,
                              fontsize: 14,
...
class FAQTextModel {
  ...
  FAQTextModel({required this.title, required this.description});
}
